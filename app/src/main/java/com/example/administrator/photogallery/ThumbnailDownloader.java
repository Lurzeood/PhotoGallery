...
/**
 * Created by Lurzeood on 2017/5/29 0029.
 */
...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    public interface ThumbnailDownloadListener<T>{
        void onThumbnailDounloaded(T target, Bitmap thumbnail);
    }
        ...
        try {
            ...
            mResponseHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mThumbnailDownloadlistener.onThumbnailDounloaded(target,bitmap);
                }
            });
